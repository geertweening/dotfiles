...
# modified version of https://raw.github.com/mathiasbynens/dotfiles/master/.osx
...
sudo scutil --set ComputerName "Geert"
sudo scutil --set HostName "Geert"
sudo scutil --set LocalHostName "Geert"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Geert"
